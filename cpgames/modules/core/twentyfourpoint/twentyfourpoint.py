...
class Config():
    ...
    # 字体路径
    FONT_PATHS_DICT = {
        'default': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 30},
        'answer': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 20},
        'info': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 40},
        'number': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 50},
    }
