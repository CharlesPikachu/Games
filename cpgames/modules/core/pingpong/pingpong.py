...
class Config():
    ...
    # 字体路径
    FONT_PATHS_DICT = {
        'default20': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 20},
        'default30': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 30},
        'default50': {'name': os.path.join(rootdir, 'resources/fonts/font.TTF'), 'size': 50},
    }
    # 游戏图片路径
    IMAGE_PATHS_DICT = {
