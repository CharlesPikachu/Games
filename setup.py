...
'''package data'''
package_data = {
    'cpgames.modules.core.aircraftwar': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*'],
    ...
    'cpgames.modules.core.breakoutclone': ['resources/audios/*', 'resources/fonts/*', 'resources/levels/*'],
    'cpgames.modules.core.bunnybadger': ['resources/audios/*', 'resources/images/*'],
    'cpgames.modules.core.catchcoins': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*'],
    ...
    'cpgames.modules.core.gemgem': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*'],
    ...
    'cpgames.modules.core.greedysnake': ['resources/audios/*', 'resources/fonts/*'],
    ...
    'cpgames.modules.core.pingpong': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*'],
    ...
    'cpgames.modules.core.sokoban': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*', 'resources/levels/*'],
    'cpgames.modules.core.tankwar': ['resources/audios/*', 'resources/fonts/*', 'resources/images/bullet/*', 'resources/images/enemyTank/*', 'resources/images/food/*', 'resources/images/home/*', 'resources/images/others/*', 'resources/images/playerTank/*', 'resources/images/scene/*'],
    ...
    'cpgames.modules.core.twentyfourpoint': ['resources/audios/*', 'resources/fonts/*'],
    'cpgames.modules.core.twozerofoureight': ['resources/audios/*', 'resources/fonts/*'],
    'cpgames.modules.core.voicecontrolpikachu': ['resources/images/*'],
    'cpgames.modules.core.whacamole': ['resources/audios/*', 'resources/fonts/*', 'resources/images/*'],
}
